...
<head>
    ...
    <title>Lupa Username - BUMDes</title>
...
<body class="login-bg min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        <div class="text-center mb-6">
            <i class="fas fa-user text-4xl text-blue-500 mb-3"></i>
            <h1 class="text-2xl font-bold text-gray-800">Lupa Username</h1>
        ...
        <form method="POST" action="{{ route('password.forgot-username') }}">
            @csrf
            ...
            <button type="submit" 
                ...
                <i class="fas fa-search mr-1"></i> Cari Username
            </button>
        </form>
