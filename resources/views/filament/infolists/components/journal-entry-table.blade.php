@php
    $transaction = $component->getTransaction();
    $entries = $transaction ? $transaction->journalEntries()->with('account')->get() : collect();
@endphp
...
<div class="overflow-x-auto">
    <table class="w-full text-sm">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="4" class="px-4 py-4 text-center text-gray-500">Belum ada jurnal</td>
                </tr>
            @endforelse
        </tbody>
        <tfoot>
